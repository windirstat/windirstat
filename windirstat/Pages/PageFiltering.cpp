...
void CPageFiltering::DoDataExchange(CDataExchange* pDX)
{
    ...
    DDX_Check(pDX, IDC_FILTERING_USE_MODIFIED_DAYS, m_filteringUseModifiedDays);
    ...
    DDX_Control(pDX, IDC_FILTERING_MODIFIED_DAYS, m_ctrlFilteringModifiedDays);
    DDX_CBIndex(pDX, IDC_FILTERING_MIN_UNITS, m_filteringSizeUnits);
    DDX_Text(pDX, IDC_FILTERING_MODIFIED_DAYS, m_filteringModifiedDays);
}
...
BEGIN_MESSAGE_MAP(CPageFiltering, CMFCPropertyPage)
    ...
    ON_BN_CLICKED(IDC_FILTERING_USE_MODIFIED_DAYS, OnSettingChanged)
    ON_EN_CHANGE(IDC_FILTERING_MODIFIED_DAYS, OnSettingChanged)
...
BOOL CPageFiltering::OnInitDialog()
{
    ...
    m_filteringUseModifiedDays = COptions::FilteringUseModifiedWithinDays;
    m_filteringModifiedDays = COptions::FilteringModifiedWithinDays;
...
void CPageFiltering::OnOK()
{
    ...
    m_filteringModifiedDays = std::clamp(m_filteringModifiedDays,
    ...
    COptions::FilteringUseModifiedWithinDays = (FALSE != m_filteringUseModifiedDays);
    COptions::FilteringModifiedWithinDays = m_filteringModifiedDays;
...
void CPageFiltering::UpdateModifiedDaysControls()
{
    m_ctrlFilteringModifiedDays.EnableWindow(FALSE != m_filteringUseModifiedDays);
}
