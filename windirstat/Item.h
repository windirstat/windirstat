...
using ITEMTYPE = enum ITEMTYPE : unsigned short
{
    ...
    IT_FREESPACE  = 5 << 0, // Pseudo File "<Free Space>"
    IT_UNKNOWN    = 6 << 0, // Pseudo File "<Unknown>"
    IT_HARDLINKS  = 7 << 0, // Pseudo File "<Hardlinks>"
    ...
    ITF_UNUSED_1  = 1 << 10, // Unused
    ITF_UNUSED_2  = 1 << 11, // Unused
...
public:
    ...
    void UpdateHardlinksItem(ULONGLONG physicalSize);
    ...
    inline bool IsItemType(Args... args) const { return HasType<IT_MASK>(false, args...); }
