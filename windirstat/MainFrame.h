...
inline std::span<const RouteEntry> CMainFrame::Routes()
{
    static constexpr std::array entries
    {
        ...
        Route::Command<&OnViewGraphPreset>(ID_VIEW_GRAPH_PRESET_CLASSIC, ID_VIEW_GRAPH_PRESET_CUSTOM),
        ...
        Route::Update<&OnUpdateViewGraphPreset>(ID_VIEW_GRAPH_PRESET_CLASSIC, ID_VIEW_GRAPH_PRESET_CUSTOM),
        ...
        Route::Command<&OnAdvancedShadowCopy>(ID_TOOLS_SHADOW_COPY_BASE,
            ID_TOOLS_SHADOW_COPY_BASE + wds::alphaSize - 1),
        Route::Command<&OnAdvancedDefrag>(ID_TOOLS_DEFRAG_BASE, ID_TOOLS_DEFRAG_BASE + wds::alphaSize - 1),
        Route::Command<&OnAdvancedChkdsk>(ID_TOOLS_CHKDSK_BASE, ID_TOOLS_CHKDSK_BASE + wds::alphaSize - 1),
